...
class MainUiClass(QtWidgets.QMainWindow, mainGUI_extended_abl.Ui_MainWindow):
    ...
    def restoreFactoryDefaults(self):
        if dialog.WarningYesNo(self, "Are you sure you want to restore machine state to factory defaults?\nWarning: Doing so will also reset printer profiles, WiFi & Ethernet config.",
            ...
            os.system('sudo cp -f config/config_Julia2021ExtendedTouchUI.yaml /home/pi/.octoprint/config.yaml')
    ...
    def run(self):
        ...
        while (True):
            ...
            try:
                ...
                print(e)
                if not Development:
                    self._logger.error("ThreadSanityCheck: " + str(e))
